...
<body>
  <form action="processa-cadastro.php" method="post">
    <div class="fancy">
      ...
      <fieldset><h2> Cadastro de Clientes</h2>

        <label>Tipo de Cliente</label><br>
        <select name="tipo_cliente">
          <option value="Pessoa Física">Pessoa Física</option><br>
          <option value="Pessoa Jurídica">Pessoa Jurídica</option><br>
        </select><br>
        ...
        <label>Telefone Adicional</label><br>
        <input type="text" id="telefone_adc" name="telefone_adc" ><br>
